...
export default function About() {
  return (
    <div className="content about">
      <h1 className="navbar-padding site-header ">About Us</h1>
      <div className="about-main">
        <div className="about-group-pic">
          <img src="/aboutus.jpg" alt="aboutus"></img>
        </div>
      ...
      <p>
        Mollitia vero error corporis id quis odio nulla perferendis quas ea
        modi! Suscipit animi eius dolores libero. Tempora, sequi possimus.
        Inventore illo voluptates sapiente dolores ipsam sed, perferendis totam.
        Rerum obcaecati maiores qui mollitia similique, doloremque nobis
        perspiciatis aspernatur harum, recusandae distinctio reprehenderit
        possimus dolorem repudiandae numquam molestias. Atque sed voluptates
        voluptatum totam nesciunt id earum! Officia reprehenderit, aliquam
        facilis optio iure quia magni perferendis molestiae ipsam veniam vitae
        excepturi blanditiis libero, possimus odit maiores quae nisi labore ab
        quod ducimus consequatur nam! Nam quisquam, dolor saepe veniam
        laudantium repellat exercitationem suscipit inventore dolore deleniti
        quidem et tempora, iure mollitia.
      </p>
      <h2>Founders</h2>
