const copyEN = {
  ...
  home: {
    manifesto: {
      ...
      part1:
        "Devhaus Leipzig grew out of the need for a place where developers could learn and contribute to meaningful projects. Our mission is to support the members of our community to reach their creative and professional goals.",
      part2:
        "Aspiring developers can take part in our Academy to learn the fundamentals of software development. Once graduated, they join our community of residents in the Studio, where their personal and professional projects find the support they need to thrive.",
      part3:
        "We have courses for learning frontend web development currently running.",
    },
    academy: {
      header: "Academy",
  ...
  academy: {
    ...
    block2: {
      ...
      courseDates:
        "The next camp: # to @" /* # is the start date, @ is the end date*/,
  ...
  studio: {
    ...
    pastProjects: {
      ...
      devhausNetwork:
        "Final Project Camp #3 - A social network for aspiring developers",
      ...
      communic:
        "Communic - A social platform for finding and contributing to projects",
    },
  },
  stories: {
    header: "",
    ...
    startupSafari:
      "Startup Safari Panel: “Developing Skills for a Digital World”",
    hypezig:
  ...
  privacy: {
    // from https://www.websitepolicies.com/policies/manage
  ...
  faq: {
    content: [
      ...
      {
        question:
          "How is Devhaus Leipzig different from other ways to learn coding?",
        answer: [
      ...
      },
      {
        ...
        answer: ["The Summer/Fall camp will begin May 5, 2022."],
      },
      {
      ...
      {
        question:
          "What kind of experience or knowledge do I need to participate in Devhaus Leipzig?",
        answer: [
      ...
      {
        question:
          "How likely is it that I will get a job through Devhaus Leipzig?",
        answer: [
      ...
      {
        question:
          "What kind of jobs can I get by participating in Devhaus Leipzig? ",
        answer: [
      ...
      {
        question:
          "Will I get to interact with companies during Devhaus Leipzig?",
        answer: [
      ...
      {
        question:
          "How can I become an instructor or guest lecturer at Devhaus Leipzig?",
        answer: [
      ...
      {
        question:
          "How can I spend time with Devhaus Leipzig students or teachers to get a feel for what it’s like?",
        answer: [
      ...
      {
        question:
          "Can I offer projects/internships/jobs to Devhaus Leipzig graduates?",
        answer: [
      ...
      {
        question:
          "I want to write a story about Devhaus Leipzig, how can I make this happen?",
        answer: [
